...
function main()
    ...
    imshow(original_img);
    title('original\_img');
    imwrite(original_img, './original_img3.bmp');
    ...
    imshow(halftone_img);
    title('halftone\_img');
    imwrite(halftone_img, './halftone_img3.bmp');
    disp("The size of the halftone_img is: ");
    disp(size(halftone_img));
    ...
    imshow(merged_img);
    title('merged\_img');
    imwrite(merged_img, './merged_img3.bmp');
    disp("The size of the merged_img is: ");
    disp(size(merged_img));
end
